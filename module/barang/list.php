...
$perHalaman = 5;
$mulai_dari = ($pagination - 1) * $perHalaman;

$query = mysqli_query($koneksi, "SELECT barang.*, kategori.kategori FROM barang JOIN kategori ON barang.kategori_id = kategori.kategori_id ORDER BY nama_barang ASC LIMIT $mulai_dari, $perHalaman");
...
if (mysqli_num_rows($query) == 0) {
	...
	echo "</table>";
	$queryHitungData = "SELECT * FROM barang";
	pagination($queryHitungData, $perHalaman, $pagination, "index.php?page=my_profile&module=barang&action=list");
}
